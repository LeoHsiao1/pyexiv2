...
1. Download [the release of Exiv2](https://github.com/Exiv2/exiv2/releases/tag/v0.28.9) :
    ```sh
    curl -O https://github.com/Exiv2/exiv2/releases/download/v0.28.9/exiv2-0.28.9-Linux-x86_64.tar.gz
    tar -zxvf exiv2-0.28.9-Linux-x86_64.tar.gz
    ```

2. Prepare environment variables according to your download path:
    ```sh
    EXIV2_DIR=??/exiv2-0.28.9-Linux-x86_64
    LIB_DIR=??/pyexiv2/lib/
    cp $EXIV2_DIR/lib/libexiv2.so.0.28.9  $EXIV2_DIR/lib/libexiv2.so
    cp $EXIV2_DIR/lib/libexiv2.so.0.28.9  $LIB_DIR/libexiv2.so
    ```
...
1. Download [the release of Exiv2](https://github.com/Exiv2/exiv2/releases/tag/v0.28.9) :
    ```sh
    curl -O https://github.com/Exiv2/exiv2/releases/download/v0.28.9/exiv2-0.28.9-2022msvc-AMD64.zip
    python -m zipfile -e exiv2-0.28.9-2022msvc-AMD64.zip .
    ```
...
3. Prepare environment variables according to your download path:
    ...
    set  EXIV2_DIR=??\exiv2-0.28.9-2022msvc-AMD64
